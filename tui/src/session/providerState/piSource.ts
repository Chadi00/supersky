...
import type { Api, KnownProvider, Model } from "../../vendor/pi-ai/types";
...
} from "../../vendor/pi-ai/utils/oauth/types";
...
export function getModels(provider: string) {
	return modelsRuntime.getModels(provider as KnownProvider) as Model<Api>[];
}
